...
export const Auth_API = 'http://localhost:5054/api/Auth'
export const Episode_API = 'http://localhost:5226/api/Episodes'
export const Movie_API = 'http://localhost:5226/api/Movies'
